...
/**
 * Created by Altarix on 14.10.2016.
 */

public class HeaderDecorationExpanded extends RecyclerView.ItemDecoration {
    ...
    public HeaderDecorationExpanded(View view, boolean scrollsHorizontally, float parallax, float shadowSize, int columns) {
        mView = view;
    ...
    public static class Builder {
        ...
        public HeaderDecorationExpanded build() {
            if (mView == null) {
                throw new IllegalStateException("View must be set with either setView or inflate");
            }
            return new HeaderDecorationExpanded(mView, mHorizontal, mParallax, mShadowSize * 1.5f, mColumns);
        }
