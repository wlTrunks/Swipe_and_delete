package net.l1ngdtkh3.swipe_and_delete.compare;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * jumpy UIs.
     */
    List<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation> mRecoverAnimations = new ArrayList<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation>();
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new android.support.v7.widget.helper.ItemTouchHelper.ItemTouchHelperGestureListener());
    }
    ...
    void select(ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation rv = new android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation(prevSelected, animationType,
    ...
    android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation findAnimation(MotionEvent event) {
    ...
    public abstract static class Callback {
        ...
        void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                    List<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation> recoverAnimationList,
